...
function BevChart() {
  return (
    <svg
      ...
      aria-label="Ontario BEV Registrations 2022-2024"
    >
      {[20, 50, 80].map((y) => (
        <line
          key={y}
      ...
      <path
        d="M38,95 L60,91 L82,86 L104,82 L126,74 L148,65 L170,54 L192,42 L214,30 L236,20 L255,14"
        fill="none"
        stroke="rgba(212,160,23,.9)"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
      <path
        d="M38,95 L60,91 L82,86 L104,82 L126,74 L148,65 L170,54 L192,42 L214,30 L236,20 L255,14 L255,100 L38,100 Z"
        fill="url(#bevGrad)"
      />
...
function GasPriceChart() {
  return (
    <svg
      viewBox="0 0 260 120"
      className="prob-chart-svg"
      aria-label="Ontario Gas Price 2022-2026"
    >
      {[25, 55, 85].map((y) => (
        <line
          key={y}
      ...
      <path
        d="M38,72 L65,60 L92,70 L119,55 L146,42 L173,50 L200,36 L227,25 L255,18"
        fill="none"
      ...
      />
      <path
        d="M38,72 L65,60 L92,70 L119,55 L146,42 L173,50 L200,36 L227,25 L255,18 L255,100 L38,100 Z"
        fill="url(#gasGrad)"
      />
      <line
        x1="38"
        ...
        strokeDasharray="4 3"
      />
      <text x="42" y="39" fontSize="7" fill="rgba(255,255,255,.34)">
        $1.80 threshold
      </text>
...
function StressProjectionChart() {
  return (
    <svg
      viewBox="0 0 260 120"
      className="prob-chart-svg"
      aria-label="Feeder Stress Projection 2026-2031"
    >
      {[20, 46, 72].map((y) => (
        <line
          key={y}
      ...
      <line
        ...
        strokeDasharray="4 3"
      />
      <text x="42" y="43" fontSize="7" fill="rgba(239,68,68,.55)">
        80% critical threshold
      </text>
      <path
        d="M38,82 L93,72 L148,57 L203,38 L255,22"
        fill="none"
      ...
      />
      <path
        d="M38,85 L93,76 L148,63 L203,47 L255,33"
        fill="none"
      ...
      />
      <path
        d="M38,88 L93,81 L148,73 L203,64 L255,55"
        fill="none"
        stroke="rgba(234,179,8,.6)"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      <path
        d="M38,92 L93,87 L148,82 L203,77 L255,72"
        fill="none"
...
function MapFig() {
  return (
    <svg viewBox="0 0 120 70" className="feat-fig-svg" aria-hidden="true">
      <path
        d="M10 38 L22 16 L46 10 L74 12 L98 6 L112 30 L108 56 L78 64 L48 60 L22 60 Z"
  ...
  return (
    <div className="feat-fig-rank" aria-hidden="true">
      ...
      <svg viewBox="0 0 24 24" className="feat-fig-pin">
        <path
          d="M12 2 C7.5 2 4 5.5 4 10 C4 16 12 22 12 22 C12 22 20 16 20 10 C20 5.5 16.5 2 12 2 Z"
          fill="rgba(10,10,10,.95)"
        />
  ...
  return (
    <svg viewBox="0 0 76 88" className="feat-fig-svg" aria-hidden="true">
      ...
      <rect
        ...
        height="14"
        rx="2"
        fill="rgba(186,117,23,.2)"
        stroke="rgba(186,117,23,.42)"
        strokeWidth=".6"
      />
      <rect
        x="12"
      ...
      <div className="sec-inner">
        <div className="prob-head">
          <div className="prob-head-left">
            ...
            <h2 className="prob-h2">
              ...
              <br />
              for what&apos;s{" "}
              <span className="serif-i prob-serif-i">coming</span>.
            </h2>
          </div>
          <div className="prob-head-right">
            <p className="prob-intro">
              EV adoption is outpacing every utility model and the macro
              tailwinds keep compounding. Iran region tensions have pushed
              Ontario gas past $2/L, while any softening of Canada&apos;s 100%
              tariff on Chinese-built EVs would release a wave of sub $25K
              models into the market. Without proactive forecasting,
              distribution networks face feeder overloads, reactive capital
              spending, and systematically inequitable infrastructure.
            </p>
            <div className="prob-kpis">
              ...
              <div className="prob-kpi">
                ...
                <span className="pkl">
                  Ontario gas peak · geopolitical shock
                </span>
              </div>
              <div className="prob-kpi">
        ...
        <div className="prob-charts">
          <div className="prob-chart-card">
            ...
            <BevChart />
            <p className="pcc-caption">
              Quarterly BEV registrations · Ontario MTO · Q2 2022–Q4 2024
            </p>
          </div>
          <div className="prob-chart-card">
            ...
            <GasPriceChart />
            <p className="pcc-caption">
              $/L weekly avg with EV adoption threshold marker · 2022–2026
            </p>
          </div>
          <div className="prob-chart-card">
            ...
            <p className="pcc-caption">
              Capacity utilisation per feeder · ZEUS base scenario · 2026–2031
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="sec-inner">
        <div className="sol-head">
          ...
          <p className="sol-intro">
            ZEUS operates as a cohesive pipeline automated data ingestion,
            machine learning, spatial analysis, and dashboard visualisation
            delivering six capabilities that distribution planners act on
            directly.
          </p>
        </div>
  ...
  return (
    <section id="contact" className="sec cta-sec">
      ...
      <div className="sec-inner cta-inner">
        ...
        <h2 className="cta-h2">
          Built to forecast the surge
          <br />
          <span className="serif-i">before</span> it arrives.
        </h2>
        <p className="cta-sub">
          ZEUS gives utility planners a neighbourhood-level, 5 year forecast of
          where demand will spike built on every macro signal conventional
        ...
        <div className="cta-actions">
          ...
          <a href="mailto:hello@zeusplatform.ca" className="cta-btn-g">
            Get in Touch
          </a>
        </div>
        ...
        <div className="cta-dividers">
          <div className="cta-stat">
            <span className="cs-n">11</span>
            <span className="cs-l">Feeders at Risk</span>
          </div>
          <div className="cta-sep" />
          <div className="cta-stat">
            <span className="cs-n">$180M+</span>
            <span className="cs-l">Deferral Potential</span>
          </div>
          <div className="cta-sep" />
          <div className="cta-stat">
            <span className="cs-n">5yr</span>
            <span className="cs-l">Planning Horizon</span>
          </div>
          <div className="cta-sep" />
          <div className="cta-stat">
            <span className="cs-n">100%</span>
            <span className="cs-l">Open Data</span>
          </div>
        </div>
      </div>
    </section>
